...
namespace KutuphaneOtomasyonuWinForm.Kullanici
{
    public partial class KullaniciGuncelleForm : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.CurrentRow.Cells[7].Value.ToString() == "K")
            {
                radioK.Checked = true;
            }
            else
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Kullanicilar kullanici = db.Kullanicilar.FirstOrDefault(x => x.kullanici_id == secilenId);
